...
```
shards build --production --release tour-of-heroes
```
...
1. Fork it ( https://github.com/jvarness/tour-of-heroes/fork )
...
- [jvarness](https://github.com/jvarness) Jake Varness - creator, maintainer
